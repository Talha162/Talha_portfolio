...
export const projects: Project[] = [
  // ── Professional Projects ──────────────────────────────────────────────────
  {
    ...
    image: '/images/project-manifesto.jpg',
    links: { store: 'https://play.google.com' },
  },
  {
    id: 'chassis',
    title: 'Chassis Doctor',
    description: 'Motorsport setup diagnostics app that helps drivers and engineers analyse chassis behaviour. Built on Supabase with Stripe payments and Gemini AI-powered setup recommendations. Includes PDF report generation, structured diagnostic workflows, and TestFlight-based testing cycles.',
    tech: ['Flutter', 'Supabase', 'Stripe', 'Gemini AI', 'PDF Reports'],
    period: 'Oct 2025 - Present',
    company: 'Infinity Softwares',
    image: '/images/project-chassis.jpg',
    figmaUrl: 'https://www.figma.com/design/yV6nTZizB8HmBqFA7g05HI/Motorsport?node-id=0-1&p=f&t=Tc0YSu0BilCdPCFn-0',
  },
  {
    id: 'docusite',
    title: 'DocuSite',
    description: 'Field documentation system for construction teams featuring offline-first data capture, cloud sync, and push notifications. Integrated the native PDFTron SDK for PDF annotation, markup, and structured report generation. Supports role-based access and TestFlight distribution for iOS.',
    tech: ['Flutter', 'Firebase', 'PDFTron SDK', 'Offline-First', 'Cloud Sync'],
    period: 'Sep 2025 - Dec 2025',
    company: 'Infinity Softwares',
    image: '/images/project-docusite.jpg',
  ...
  },
  {
    ...
    image: '/images/projects/cricket/home.png',
    images: [
  ...
  },
  {
    ...
    period: '2023 - 2024',
    image: '/images/projects/asthma/home.png',
    images: [
  ...
  },
  {
    ...
    period: '2023 - 2024',
    image: '/images/projects/gamegrid/home.png',
    images: [
  ...
  },
  {
    ...
    period: '2023 - 2024',
    image: '/images/projects/dryneedling/home.png',
    images: [
  ...
  },
  {
    id: 'onlynoodle',
    title: 'Only Noodle',
    description: 'Noodle-focused food ordering app with a clean and appetising UI. Customers browse a curated noodle menu, customise orders, and track delivery status. Features an engaging onboarding experience, categorised menu browsing, and a streamlined checkout flow.',
    tech: ['Flutter', 'Firebase', 'REST APIs', 'Food Ordering'],
    period: '2023 - 2024',
  ...
  },
  {
    id: 'passionport',
    title: 'Passionport',
    description: 'Social networking app connecting people through shared interests and passions. Users create passion-based profiles, discover communities, and interact through posts and real-time chat. Features interest-based discovery, activity feeds, and a clean modern social UI.',
    tech: ['Flutter', 'Firebase', 'Real-Time Chat', 'Social Feed'],
    period: '2023 - 2024',
  ...
  },
  {
    ...
    description: 'Sports management app for USA soccer leagues covering team registration, match scheduling, and live score updates. Admins manage tournaments and brackets while players and fans follow their teams, view standings, and receive match notifications.',
    tech: ['Flutter', 'Firebase', 'Sports Management', 'Push Notifications'],
    period: '2023 - 2024',
  ...
  },
  {
    id: 'retroflyy',
    title: 'RetroFlyy',
    description: 'Travel discovery and booking app with a retro-inspired aesthetic. Users explore destinations, browse curated travel packages, and book trips through an intuitive flow. Features destination search, package details, traveller reviews, and a wishlist system.',
    tech: ['Flutter', 'REST APIs', 'Firebase', 'Travel & Booking'],
    period: '2023 - 2024',
  ...
  },
  {
    id: 'farmer',
    title: 'Farmer App',
    description: 'Agricultural management app connecting farmers with markets and advisory services. Helps farmers log crop data, monitor field conditions, access weather-based farming tips, and connect directly with buyers. Designed to digitise and simplify day-to-day farm management.',
    tech: ['Flutter', 'Firebase', 'REST APIs', 'Agriculture Tech'],
    period: '2023 - 2024',
  ...
  },
  {
    ...
    description: 'Vehicle fleet tracking and management solution for logistics companies. Real-time GPS tracking of all fleet vehicles, driver assignment, route optimisation, trip history, and fuel/maintenance logging. Role-based access for fleet managers, dispatchers, and drivers.',
    tech: ['Flutter', 'Firebase', 'Google Maps', 'Real-Time Tracking', 'Role-Based Access'],
    period: '2023 - 2024',
